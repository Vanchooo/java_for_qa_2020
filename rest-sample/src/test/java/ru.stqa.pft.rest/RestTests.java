...
public class RestTests {
    ...
    public void testCreateIssue() throws IOException {
        ...
        Issue newIssue = new Issue().withSubject("Vanya issue").withDescrtiption("My description");
    ...
    @Test
    public void getRightIssue() throws IOException {
        String json = getExecutor().execute(Request.Get("https://bugify.stqa.ru/api/issues/1.json")).returnContent().asString();
